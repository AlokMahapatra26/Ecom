...
const Filter = () => {
  ...
  const [priceFilter, setPriceFilter] = useState({ minPrice: 0, maxPrice: 10000 })
      ...
      <Accordion type="multiple" defaultValue={["1", "2", "3", "4"]}>
        ...
        <AccordionItem value="2">
          ...
          <AccordionContent>
            <div className='max-h-48 overflow-auto'>
              <ul>
                {colorData && colorData.success && colorData.data.map((color: string) => (
        ...
        <AccordionItem value="4">
          ...
          <AccordionContent>
            <Slider defaultValue={[0, 10000]} max={10000} step={1} onValueChange={handlePriceChange} />
